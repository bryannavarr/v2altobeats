        ...
        <div className="wrap mt-12">
          <div className="content">
            <div className="rowe">
              ...
              <a
                className="set"
                href="https://open.spotify.com/album/5PYnxFWsPgOFLsXfQfzlqI"
              >
                <span className="layer one">
                  <Image
                    src="https://i.scdn.co/image/ab67616d00001e02a04d1f9ca24044bfaee2a22f"
                    alt="We Should Escape by River Nelson & AltoBeats album artwork"
                    width={256}
                    height={256}
                  />
                </span>
              ...
              <a
                className="set"
                href="https://open.spotify.com/album/1jYThDGnBMmhKOc0yoFdZg"
              >
                <span className="layer one">
                  <Image
                    src="https://i.scdn.co/image/ab67616d00001e024d360aa265b20a602eb8d0f7"
                    alt="Mindfulness single By River Nelson & AltoBeats artwork"
                    width={256}
                    height={256}
                  />
                </span>
              ...
              <a
                className="set"
                href="https://open.spotify.com/album/2rgDVqAbzGob6GOM5pjZlB"
              >
                <span className="layer one">
                  <Image
                    src="https://i.scdn.co/image/ab67616d00001e02abb265295b9e5b5d29aa6684"
                    alt="Past Life instrumental by AltoBeats artwork"
                    width={256}
                    height={256}
                  />
                </span>
              ...
              >
                <span className="layer one">
                  <Image
                    ...
                    alt="Future instrumental by AltoBeats artwork"
                    width={256}
                    height={256}
                  />
                </span>
              ...
              >
                <span className="layer one">
                  <Image
                    ...
                    alt="artwork for Midichlorians instrumental produced by Altobeats"
                    width={256}
                    height={256}
                  />
                </span>
